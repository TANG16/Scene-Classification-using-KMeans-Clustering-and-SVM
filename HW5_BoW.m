...
% Last modified: 16-Oct-2018    
    ...
    methods (Static)
        function main()
            ...
            tstIds = ml_load('C:\Users\Saif\Desktop\ms\sem 1\ML\HW5\hw5data\bigbangtheory_v2\test.mat', 'imIds'); 
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %please refer trian.m for training and prediction
            %model=svmtrain(trLbs,trD','-s 0 -t 2');
        ...
        function bowCs = learnDictionary(scales, normH, normW)
            ...
            nPatch2Sample = 200000;
            
            % load train ids
            trIds = ml_load('C:/Users/Saif/Desktop/ms/sem 1/ML/HW5/hw5data/bigbangtheory_v2/train.mat', 'imIds'); 
            ...
            for i=1:length(trIds)
                ...
                im = imread(sprintf('C:/Users/Saif/Desktop/ms/sem 1/ML/HW5/hw5data/bigbangtheory_v2/%06d.jpg', trIds(i)));
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %randwins is dxn matrix
            [bowCs,tlb]=km_Utils2.km(1000,randWins',0);
            bowCs=bowCs';
        ...
        function D = cmpFeatVecs(imIds, scales, normH, normW, bowCs)
            ...
            for i=1:n
                ...
                im = imread(sprintf('C:/Users/Saif/Desktop/ms/sem 1/ML/HW5/hw5data/bigbangtheory_v2/%06d.jpg', imIds(i)));                                
